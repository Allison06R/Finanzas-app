...
<head>
    ...
    <title>Nueva Categoría - FinanzasApp</title>
        ...
        <div class="col-md-10 p-0">
            <div class="topbar d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <small class="text-muted">Crea una nueva categoría</small>
                </div>
                ...
                <div class="bg-white rounded-3 p-4" style="max-width: 500px;">
                    ...
                    <form method="POST" action="{{ route('categorias.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="color" name="color" class="form-control form-control-color" value="{{ old('color', '#1D9E75') }}" required>
                        </div>
                        <button type="submit" class="btn-verde w-100 py-2">Guardar categoría</button>
                    </form>
                </div>
            </div>
        </div>
